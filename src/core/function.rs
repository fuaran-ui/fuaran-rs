//! The signature-searchable function registry — the Core twin of
//! `Fuaran.Core.FunctionRegistry`. Published, and documented, as
//! `crate::function`, which re-exports this module whole.
