//! The Transform evaluator and list-param substitution — the Core twin of the
//! reference DataFrame evaluator. Published, and documented, as
//! `crate::transform`, which re-exports this module whole.
